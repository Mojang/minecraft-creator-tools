...
module.exports = {
  ...
  packagerConfig: {
    ...
    prune: true,
    junk: true,
    // Use asar with unpack for files that need to be spawned as child processes
    // The CLI (jsn folder) must be unpacked because:
    // 1. Node.js cannot spawn scripts from inside asar archives
    // 2. The Copilot SDK needs to spawn the MCP server as a child process
    asar: {
      unpack: "**/toolbuild/jsn/**/*",
    },
    win32metadata: {
      CompanyName: "Mojang",
