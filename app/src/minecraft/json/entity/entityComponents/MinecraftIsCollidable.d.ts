 ...
 * used on mobs and enables collisions exclusively between
 * mobs.
Please note that this type of collision is unreliable for
 * moving collidable mobs. It is recommended to use this component only
 * in scenarios where the collidable mob remains
 * stationary.
Collidable behavior is closely related to
 * stackable behavior. While the "minecraft:is_collidable" component
 * governs how other mobs interact with the component's owner, the
