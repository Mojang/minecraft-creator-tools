 ...
 * 
 * minecraft:navigation.hover Samples
...
/**
 * Hover Navigation (minecraft:navigation.hover)
 * Allows this entity to generate paths in the air like the vanilla
 * Bees do. Keeps them from falling out of the skies and doing
 * predictive movement.
 */
export default interface MinecraftNavigationHover {
