 ...
 * 
 * minecraft:navigation.climb Samples
...
/**
 * Climb Navigation (minecraft:navigation.climb)
 * Allows this entity to generate paths that include vertical walls
 * like the vanilla Spiders do.
 */
export default interface MinecraftNavigationClimb {
