 ...
 * 
 * minecraft:navigation.float Samples
...
/**
 * Float Navigation (minecraft:navigation.float)
 * Allows this entity to generate paths by flying around the air
 * like the regular Ghast.
 */
export default interface MinecraftNavigationFloat {
