        ...
        <div className="itae-mainArea">
          ...
          >
            <Stack direction="row" spacing={0.5} aria-label={this.props.intl.formatMessage({ id: "project_editor.item_attach.aria_actions" })}>
              ...
              <Button onClick={this._setTexturesMode} title="Textures">
                <CustomTabLabel
              ...
              <Button onClick={this._setGeometryMode} title="Geometry">
                <CustomTabLabel
              ...
              <Button onClick={this._setMaterialsMode} title="Materials">
                <CustomTabLabel
              ...
              <Button onClick={this._setAnimationsMode} title="Animations">
                <CustomTabLabel
