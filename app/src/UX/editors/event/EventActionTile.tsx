...
import { CustomSlimLabel } from "../../shared/components/feedback/labels/Labels";
...
export default class EventActionDesign extends Component<IEventActionDesignProps, IEventActionDesignState> {
  ...
  render() {
    ...
    if (this.props.event.hasCommand) {
      actionElements.push(
        <div key="eat-command" className="eat-functionsHeader">
          <LazyFunctionEditor
    ...
    const tileColors = getThemeColors();

    return (
      <div
        className={areaClass}
        style={{
          backgroundColor: tileColors.background3,
          color: tileColors.foreground3,
          borderColor: tileColors.background1,
        }}
      >
