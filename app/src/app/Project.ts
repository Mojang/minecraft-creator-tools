...
export default class Project {
  ...
  public get defaultNamespace() {
    ...
    return ProjectUtilities.canonicalizeNamespace(this.title);
  }

  public set defaultNamespace(newDefaultNamespace: string) {
          ...
          if ((pi === undefined || pi === null) && projectPath !== undefined) {
            ...
            if (canonFileName === "manifest.json") {
              ...
              if (folderContext === FolderContext.behaviorPack && folderPath.indexOf("/loot_tables/") >= 0) {
                ...
                (folderContext === FolderContext.resourcePack && folderPath.indexOf("/textures/") >= 0)
              ) {
              ...
              } else if (folderContext === FolderContext.resourcePack && baseName === "blocks") {
  ...
  async ensureDefaultBehaviorPackFolder(force?: boolean): Promise<IFolder> {
    ...
    this.#defaultBehaviorPackFolder = this.#behaviorPacksContainer.ensureFolder(
      MinecraftUtilities.makeNameFolderSafe(this.name)
    );
