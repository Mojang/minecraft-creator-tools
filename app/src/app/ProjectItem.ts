...
export default class ProjectItem {
  ...
  async updateAutogeneratedSideFiles() {
    ...
    if (this.itemType === ProjectItemType.worldTest) {
      const worldTestManager = await WorldTestManager.ensureWorldTestOnFile(this._file);

      if (worldTestManager) {
        await worldTestManager.persistSideFiles(this._project);
      }
    }
  }
