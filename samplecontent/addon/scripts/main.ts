...
const ZooMobList = ["aop_mobs:biceson", "aop_mobs:black_bear", "aop_mobs:boomfly", "aop_mobs:sheepomelon", "aop_mobs:wraith"];

function mainTick() {
  ticksSinceLoad++;

  if (ticksSinceLoad === 100) {
    world.sendMessage("Welcome to the wacky zoo 1.0!");
    initialize();
  }
