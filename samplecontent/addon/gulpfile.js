...
function create_content_layout_1_bp() {
  return gulp
    .src(["build/behavior_packs/" + bpfoldername + "/**/*"])
    .pipe(gulp.dest("build/content1/Content/behavior_packs/" + bpfoldername + "/"));
}
...
function create_content_1_zip() {
  return gulp
    .src(["build/content1/**/*"])
    .pipe(zip("aop_moremobs_wellformed.zip"))
    .pipe(gulp.dest("build/packages/"));
}

function create_content_layout_2_rp() {
  return gulp
    .src(["altdiffs/2/resource_packs/" + rpfoldername + "/**/*"])
    .pipe(gulp.dest("build/content2/Content/resource_packs/" + rpfoldername + "/"));
}

function create_content_layout_2_bp() {
  return gulp
    .src(["altdiffs/2/behavior_packs/" + bpfoldername + "/**/*"])
    .pipe(gulp.dest("build/content2/Content/behavior_packs/" + bpfoldername + "/"));
}
...
function create_content_layout_3_rp() {
  return gulp
    ...
    .pipe(gulp.dest("build/content3/Content/resource_packs/" + rpfoldername + "/"));
}

function create_content_layout_3_bp() {
  return gulp
...
function create_content_layout_3_bpa() {
  return gulp
    .src(["altdiffs/3/behavior_packs/" + bpfoldername + "_2/**/*"])
    .pipe(gulp.dest("build/content3/Content/behavior_packs/" + bpfoldername + "_2/"));
}

function create_content_layout_3_scripts() {
  return gulp
    .src(["build/behavior_packs/" + bpfoldername + "/scripts/**/*"])
    .pipe(gulp.dest("build/content3/Content/behavior_packs/" + bpfoldername + "_2/scripts/"));
}

function create_content_layout_3_acc() {
  return gulp.src(["accessory_files/**/*"]).pipe(gulp.dest("build/content3/"));
}

function create_content_3_zip() {
  return gulp
    .src(["build/content3/**/*"])
...
function create_content_layout_linkerrors_base_bp() {
  return gulp
    .src(["build/behavior_packs/" + bpfoldername + "/**/*"])
    .pipe(gulp.dest("build/content_linkerrors/Content/behavior_packs/" + bpfoldername + "/"));
}
...
function create_content_layout_vnext_base_bp() {
  return gulp
    .src(["build/behavior_packs/" + bpfoldername + "/**/*"])
    .pipe(gulp.dest("build/contentvnext/Content/behavior_packs/" + bpfoldername + "/"));
}
...
function create_content_layout_vnext_bp() {
  return gulp
    .src(["altdiffs/vnext/behavior_packs/" + bpfoldername + "/**/*"])
    .pipe(gulp.dest("build/contentvnext/Content/behavior_packs/" + bpfoldername + "/"));
}
...
function create_content_layout_vnext_scripts() {
  return gulp
    .src(["build/behavior_packs/" + bpfoldername + "/scripts/**/*"])
    .pipe(gulp.dest("build/contentvnext/Content/behavior_packs/" + bpfoldername + "/scripts/"));
}
...
function create_content_vnext_zip() {
  return gulp
    .src(["build/contentvnext/**/*"])
    .pipe(zip("aop_moremobs_vnext.zip"))
    .pipe(gulp.dest("build/packages/"));
}

function create_content_vnext_mcaddon() {
  return gulp
    .src(["build/contentvnext/content/**/*"])
    .pipe(zip("aop_moremobs_vnext.mcaddon"))
    .pipe(gulp.dest("build/packages/"));
}
...
function create_content_layout_vnext2_base_bp() {
  return gulp
    .src(["build/behavior_packs/" + bpfoldername + "/**/*"])
    .pipe(gulp.dest("build/contentvnext2/Content/behavior_packs/" + bpfoldername + "/"));
}
...
function create_content_layout_vnext2_bp() {
  return gulp
    .src(["altdiffs/vnext2/behavior_packs/" + bpfoldername + "/**/*"])
    .pipe(gulp.dest("build/contentvnext2/Content/behavior_packs/" + bpfoldername + "/"));
}
...
function create_content_layout_vnext2_scripts() {
  return gulp
    .src(["build/behavior_packs/" + bpfoldername + "/scripts/**/*"])
    .pipe(gulp.dest("build/contentvnext2/Content/behavior_packs/" + bpfoldername + "/scripts/"));
}
...
function create_content_vnext2_zip() {
  return gulp
    .src(["build/contentvnext2/**/*"])
    .pipe(zip("aop_moremobs_vnext2.zip"))
    .pipe(gulp.dest("build/packages/"));
}

function create_content_vnext2_mcaddon() {
  return gulp
    .src(["build/contentvnext2/content/**/*"])
    .pipe(zip("aop_moremobs_vnext2.mcaddon"))
    .pipe(gulp.dest("build/packages/"));
}

function create_content_layout_vnext3_base_rp() {
  return gulp
    .src(["build/resource_packs/" + rpfoldername + "/**/*"])
    .pipe(gulp.dest("build/contentvnext3/Content/resource_packs/" + rpfoldername + "/"));
}

function create_content_layout_vnext3_base_bp() {
  return gulp
    .src(["build/behavior_packs/" + bpfoldername + "/**/*"])
    .pipe(gulp.dest("build/contentvnext3/Content/behavior_packs/" + bpfoldername + "/"));
}

function create_content_layout_vnext3_rp() {
  return gulp
    .src(["altdiffs/vnext3/resource_packs/" + rpfoldername + "/**/*"])
    .pipe(gulp.dest("build/contentvnext3/Content/resource_packs/" + rpfoldername + "/"));
}

function create_content_layout_vnext3_bp() {
  return gulp
    .src(["altdiffs/vnext3/behavior_packs/" + bpfoldername + "/**/*"])
    .pipe(gulp.dest("build/contentvnext3/Content/behavior_packs/" + bpfoldername + "/"));
}

function create_content_layout_vnext3_scripts() {
  return gulp
    .src(["build/behavior_packs/" + bpfoldername + "/scripts/**/*"])
    .pipe(gulp.dest("build/contentvnext3/Content/behavior_packs/" + bpfoldername + "/scripts/"));
}

function create_content_layout_vnext3_acc() {
  return gulp.src(["accessory_files/**/*"]).pipe(gulp.dest("build/contentvnext3/"));
}

function create_content_vnext3_zip() {
  return gulp
...
exports.package = gulp.series(
  ...
  gulp.parallel(
    ...
    create_content_layout_vnext2_base_bp,
  ...
  gulp.parallel(
    ...
    create_content_layout_2_bp,
    create_content_layout_2_scripts,
    create_content_layout_2_acc,
    create_content_layout_3_rp,
    create_content_layout_3_bp,
    ...
    create_content_layout_vnext2_bp,
