...
const copyTaskIngameOptions: CopyTaskParameters = {
  copyToBehaviorPacks: [`./behavior_packs/creator_tools_ingame`, `./behavior_packs/common`],
  copyToScripts: ["./dist/ingame/scripts"],
  copyToResourcePacks: [`./resource_packs/creator_tools_ingame`, `./resource_packs/common`],
};

const copyTaskEditorOptions: CopyTaskParameters = {
  copyToBehaviorPacks: [`./behavior_packs/creator_tools_editor`, `./behavior_packs/common`],
  copyToScripts: ["./dist/editor/scripts"],
  copyToResourcePacks: [`./resource_packs/creator_tools_editor`, `./resource_packs/common`],
};

const mcaddonTaskIngameOptions: ZipTaskParameters = {
  ...copyTaskIngameOptions,
  outputFile: `./dist/packages/creator_tools_ingame.mcaddon`,
};

const mcaddonTaskEditorOptions: ZipTaskParameters = {
  ...copyTaskEditorOptions,
  outputFile: `./dist/packages/creator_tools_editor.mcaddon`,
};

const mcaddonTaskIngameBundleOptions: ZipTaskParameters = {
  ...copyTaskIngameOptions,
  outputFile: `./../app/public/data/content/creator_tools_ingame.mcaddon`,
};

const mcaddonTaskEditorBundleOptions: ZipTaskParameters = {
  ...copyTaskEditorOptions,
  outputFile: `./../app/public/data/content/creator_tools_editor.mcaddon`,
};
...
task("build-all", series("build-ingame", "build-editor"));
...
// Mcaddon
task("create-ingame-mcaddon-file-bundle", series(setEnvIngame, mcaddonTask(mcaddonTaskIngameBundleOptions)));
task("create-editor-mcaddon-file-bundle", series(setEnvEditor, mcaddonTask(mcaddonTaskEditorBundleOptions)));

task(
  "mcaddon-ingame",
  series("clean-local-ingame", "build-ingame", "create-ingame-mcaddon-file", "create-ingame-mcaddon-file-bundle")
);

task(
  "mcaddon-editor",
  series("clean-local-editor", "build-editor", "create-editor-mcaddon-file", "create-editor-mcaddon-file-bundle")
);

task("package-ingame", series("create-ingame-mcaddon-file", "create-ingame-mcaddon-file-bundle"));

task(
  "package-all",
  series(
    "create-ingame-mcaddon-file",
    "create-editor-mcaddon-file",
    "create-ingame-mcaddon-file-bundle",
    "create-editor-mcaddon-file-bundle"
  )
);
